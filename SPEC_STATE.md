...
| **Decisions Resolved** | 21 / ~150-200 (estimated) |
| **Open Questions** | — |
| **Last Session** | 2026-06-30 |
| **Last Session Summary** | Ch 02 reopened and completed properly (D-017 to D-021: tsconfig, changesets, workspace refs, sub-path exports, CI pipeline). Re-locked at 13 decisions. Ch 00 now unblocked and is next. |
| **Next Recommended Action** | Scope Ch 00: Agent Conventions & Shared Contract — both Ch 01 and Ch 02 LOCKED. Target ~18-20 questions per calibration rules in AGENTS.md. |
| **Blocked Items** | None |
...
| IMP-005 | Ch 02 (D-009) | Ch 00 | Monorepo structure defines folder conventions | Pending |
| IMP-006 | Ch 02 (D-010) | Ch 00, Ch 03 | Package names define all import statements | Pending |
| IMP-007 | Ch 02 (D-011) | Ch 03 | Headless + styled defines component API surface | Pending |
| IMP-008 | Ch 02 (D-013) | Ch 00 | ESM-only constrains import/export conventions | Pending |
| IMP-009 | Ch 02 (D-016) | Ch 04 | Example API route is canonical backend reference | Pending |
| IMP-010 | Ch 02 (D-017) | Ch 00 | Root tsconfig.base.json is TS config source of truth | Pending |
